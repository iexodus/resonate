...
?>
<div data-status="active" data-creator-id="<?php print $project->nid;?>" data-behavior=" " class="panel sheet project active inactive">
	<header><h1><a data-restore-position="" href="<?php if($project->type == 'project') print $base_url.'/'.$alias; else print $base_url.'/calendar';?>"><?php print $project->title;?></a></h1></header>
												                ...
												                <td class="groups">
												                    ...
												                    <div class="group_options">
												                        ...
												                        foreach ($companies as $company) {
												                            ?>
												                            <a data-group-id="group_<?= $company->id ?>" data-member-ids="[<?= $company->uids ?>]" class="companies_options">
												                            ...
												                            <div class="subgroup_options">
												                                ...
												                                foreach ($company->groups as $group) {
												                                    ?>
												                                    <a data-parent-group-id="group_<?= $company->id ?>" data-group-id="group_<?= $group->id ?>" data-member-ids="[<?= $group->uids ?>]" class="subgroup">
